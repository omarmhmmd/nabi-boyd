export default {
  projects: [
    ...
    },
    {
      ...
      "SITEAREA": "0.87 Acre",
      "CLIENT": "Private",
      "DESCRIPTION": "Located on a steep Cherimoya orchard in the foothills of Carpinteria, Shepard Mesa House is a new home for a young family of four. The neighborhood consists of dispersed homes along a single road leading up and around the crown of the hill.</br></br> Sited diagonally to the contours of the hill, the house slopes with the natural fall of the land. Interior functions at three levels are gathered under a large gable roof. Bedrooms at the lower elevations are nestled into the working orchard around them where the trees provide the most privacy. The living room, dining area and kitchen on the upper level opens downslope and affords the most expansive views. Neighboring homes are just out of sight as the view stretches out across the valley to the backside of Rincon Mountain.</br></br>The siting, orientation, and plan take advantage of natural light and ventilation reducing the reliance on mechanical systems and creating a living experience in harmony with the site."
    },
    {
